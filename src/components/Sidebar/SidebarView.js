...
const structure = [
  ...
  { id: 1, label: 'allVendors', link: '/app/allVendors', icon: <TypographyIcon /> },
  { id: 2, label: 'allCustomers', link: '/app/allCustomers', icon: <TableIcon /> },
  { id: 3, label: 'allOrders', link: '/app/allOrders', icon: <NotificationsIcon />},
