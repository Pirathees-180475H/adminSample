...
function Dashboard({setChartShow,totalOrders,totalTransaction,customer}) {
    ...
    if(totalOrders && totalTransaction){TotalOrderCount=totalOrders;TotalTransaction=totalTransaction}
                        ...
                        React.createElement(Box, null,
                            React.createElement(Grid, { container: true },
                                React.createElement(Grid, { item: true, xs: 8 },
                                    React.createElement(BarChart, {id:customer.id})),
                                React.createElement(Grid, { item: true, xs: 4 },
                                    React.createElement(PieChart, {id:customer.id}))))
